...
- [#86](https://github.com/wolfstar-project/plugins/pull/86) [`15332ef`](https://github.com/wolfstar-project/plugins/commit/15332ef94b27f3b2140b3560cda77e456d685384) - Fix TypeScript overload resolution in `getSupportedLanguageT`, `getSupportedUserLanguageT`, and `fetchKey` when `key` is a union type (such as a ternary expression).
